...
namespace Utils.Responses
{
    ...
    {
        // init: sadece başlangıçda doldurabilir alandır.
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public static Result<T> Success(T data, int statusCode = 200, string? messsage = null) => new(data, true, statusCode, messsage);
